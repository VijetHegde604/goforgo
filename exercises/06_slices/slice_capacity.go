...
func main() {
	...
	slice1 := make([]int, 5, 10) // Create a slice with length 5 and capacity 10
	...
	slice2 := array[2:6] // Create slice from array[2:6]
	...
	slice3 := base[:5]  // Create slice from base[1:4]
	slice4 := base[2:7] // Create slice from base[3:6]
	...
	fullSlice := base[1:4:5] // Create slice with base[1:4:5] to limit capacity
