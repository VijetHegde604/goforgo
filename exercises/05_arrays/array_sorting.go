...
func main() {
	...
	numbers := [5]int{64, 34, 25, 12, 22} // Complete this with [5]int{64, 34, 25, 12, 22}

	//  Create an array of strings to sort
	names := [4]string{"Charlie", "Alice", "Bob", "David"} // Complete this with [4]string{"Charlie", "Alice", "Bob", "David"}

	//  Create an array of float64 to sort
	prices := [6]float64{19.99, 9.99, 29.99, 4.99, 39.99, 14.99} // Complete this with [6]float64{19.99, 9.99, 29.99, 4.99, 39.99, 14.99}
	...
	isSorted := sort.IntsAreSorted(numbers[:]) // Check if numbers slice is sorted
