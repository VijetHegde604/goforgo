...
func main() {
	...
	var numbers []int
	// Append the number 1
	numbers = append(numbers, 1) // Complete this append operation

	//  Append multiple elements at once
	// Append 2, 3, 4 to numbers
	numbers = append(numbers, 2, 3, 4) // Complete this append operation

	//  Append elements from another slice
	moreNumbers := []int{5, 6, 7}
	// Hint: Use ... to expand the slice
	numbers = append(numbers, moreNumbers...) // Complete this append operation
	...
	var colors []string
	colors = append(colors, "red") // Append "red" to the nil slice
